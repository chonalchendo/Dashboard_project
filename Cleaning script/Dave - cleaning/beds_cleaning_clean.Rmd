...
beds_16_to_21 <- beds_16_21 %>% 
  ...
  ungroup() %>% 
  select(quarter, hb, specialty_name, percentage_occupancy, percentage_occupancy_by_board, wards_over_ninety, percent_wards_over_ninety)
...
beds_16_to_21 %>% 
  ...
  count(quarter, hb, percent_wards_over_ninety)

beds_16_to_21 %>% 
  count(quarter, hb, percentage_occupancy_by_board)
...
st_write(dropped_joined_beds, here::here("../../clean_data/map_beds.geojson"), append = TRUE)
